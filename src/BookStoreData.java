...
public class BookStoreData {
    ...
    private void seedSampleData() {
        ...
        customers.add(new Customer("Favourite Books Reader", "customer@favouritebooks.com", "customer123",
                "0412345678", "1 Favourite Lane, Melbourne VIC"));

        admins.add(new Admin("Store Manager", "admin@favouritebooks.com", "admin123"));
    }
